...
<div class="container">
    ...
    <form action="{{ route('teams.update', $team->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <img src="{{ asset('images/'.$team->image) }}" alt="{{ $team->name }}" width="100" class="mt-2">
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Description</label>
            <textarea class="form-control" id="description" name="description" required>{{ $team->description }}</textarea>
        </div>
